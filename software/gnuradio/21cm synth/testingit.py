...
class testingit(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "testingit")
        ...
        self.rf_bandwidth = rf_bandwidth = 3000000
        ...
        self.blocks_integrate_xx_0 = blocks.integrate_ff(1000, 1024)
        ...
        self.connect((self.blocks_integrate_xx_0, 0), (self.blocks_vector_sink_x_0, 0))
        self.connect((self.blocks_stream_to_vector_0, 0), (self.fft_vxx_0, 0))
        self.connect((self.fft_vxx_0, 0), (self.blocks_complex_to_mag_squared_0, 0))
        self.connect((self.pluto_rx, 0), (self.blocks_stream_to_vector_0, 0))
        self.connect((self.pluto_rx, 0), (self.qtgui_sink_x_0, 0))
...
def main(top_block_cls=testingit, options=None):
