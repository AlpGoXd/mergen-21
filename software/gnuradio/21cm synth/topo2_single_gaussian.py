...
# Title: Topo 2: Single Gaussian Line
# Author: Mergen-21
# Description: Topo 2: Single Gaussian H-line
...
class topo2_single_gaussian(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "Topo 2: Single Gaussian Line", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("Topo 2: Single Gaussian Line")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "topo2_single_gaussian")
        ...
        self.LO_freq = LO_freq = 1419000000
        ...
        self.top_grid_layout.addWidget(self._qtgui_vector_sink_f_0_win, 1, 0, 2, 8)
        for r in range(1, 3):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
        ...
        self.top_grid_layout.addWidget(self._qtgui_freq_sink_0_win, 3, 0, 2, 8)
        for r in range(3, 5):
            self.top_grid_layout.setRowStretch(r, 1)
        for c in range(0, 8):
            self.top_grid_layout.setColumnStretch(c, 1)
...
def main(top_block_cls=topo2_single_gaussian, options=None):
